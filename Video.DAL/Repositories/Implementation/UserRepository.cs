namespace Video.DAL.Repositories.Implementation
{
    ...
    public class UserRepository : BaseRepository, IUserRepository
    {
        ...
        {
            return await GetAsync<UserDto>($@"select id as Id, user_name as UserName,first_name as FirstName,last_name as LastName, email_address as Email, is_active as IsActive from public.users where email_address = '{model.Email}' and password = '{model.Password.GetSha1Hash()}'");
        }
        ...
        {
            return await GetAsync<UserDto>($@"select id as Id, user_name as UserName,first_name as FirstName,last_name as LastName, email_address as Email, is_active as IsActive from public.users where activation_token = '{activationToken}'");
        }
